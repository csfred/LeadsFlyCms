...
public class EmailService {
    ...
    public void sendEmail(String userEmail,String code, String tpCode) throws MessagingException {
         ...
         * 设置邮件标题
         */
        message.setSubject(email.getTitle() == null ? "电气之家测试邮件" : email.getTitle(), "GBK");
     ...
     * @return
     */
    public DataVo updateEmailTemplatesById(Email email){
    ...
    public Email findEmailTemplateById(Integer id){
